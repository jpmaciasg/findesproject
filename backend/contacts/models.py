...
class ContactUser (models.Model):
    id = models.AutoField(primary_key=True)
    cu_contact_id = models.ForeignKey(Contact, to_field= 'id', db_column = 'cu_contact_id', on_delete = models.CASCADE) 
    cu_id = models.ForeignKey(User, to_field= 'id', db_column = 'cu_id', on_delete = models.CASCADE) 
