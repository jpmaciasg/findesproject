...
class User(AbstractUser):
    ...
    role_key = models.ForeignKey(Role, to_field='role_key', db_column = 'role_key', on_delete = models.SET_NULL, null=True)
    email = models.CharField(blank=True, null=True, max_length=254)
    avatar = models.CharField(blank=True, null=True, max_length=254)
    ...
    class Meta:
        db_table = 'crm_user'
        ordering = ['username','first_name','last_name','role_key', 'role_key__role_label','role_key__role_name']
