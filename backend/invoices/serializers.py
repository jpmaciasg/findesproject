...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    fac_uuid = serializers.CharField(read_only=True)
    ...
    class Meta(object):
        ...
        fields = ('fac_key','fac_serie','fac_folio', 'fac_emisorrfc', 'fac_emisornombre',
                  ...
                  'fac_complemento', 'fac_idclient','fac_iduser', 'first_name', 'last_name', 'username','fac_expectedpaymentday','fac_edupdatescount','fac_uuid')
...
class InvoiceNoXmlSerializer(serializers.ModelSerializer):
    ...
    class Meta(object):
        ...
        fields = ('fac_key','fac_serie','fac_folio', 
                  ...
                  'fac_complemento', 'fac_idclient','fac_iduser', 'first_name', 'last_name', 'username','fac_expectedpaymentday','fac_isactivetext','fac_edupdatescount','fac_uuid')
